...
# Zihao: I implement `rnmf2` naively to compare with authors' two algorithms
...
##------------------------------------------------------------
## functions implemented by the author 
## compute_nmf & compute_rnmf
##------------------------------------------------------------
...
##------------------------------------------------------------
## functions implemented by Zihao
## compute_rnmf2
##------------------------------------------------------------
## compute sum of square loss
def cost(A, W,H):
	return np.power(A - W.dot(H), 2).sum()
